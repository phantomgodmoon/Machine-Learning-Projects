...
def training_loop(dataloader_X, dataloader_Y, test_dataloader_X, test_dataloader_Y, device, opts):
    ...
    for iteration in range(1, opts.train_iters+1):
        ...
        if opts.loss_fn == 'div':
            ...
            D_X_loss = nn.MSELoss(D_X(images_X),real_labels_X)
            D_Y_loss = nn.MSELoss(D_Y(images_Y),real_labels_Y)
        ...
        if opts.loss_fn == 'div':
            ...
            D_X_loss = nn.MSELoss(D_X(fake_X),fake_labels_Y)
        ...
        if opts.loss_fn == 'div':
            ...
            D_Y_loss = nn.MSELoss(D_Y(fake_Y),fake_labels_X)
        ...
        if opts.loss_fn == 'div':
            ...
            g_loss = nn.MSELoss(D_X(fake_X),real_labels_Y) 
        ...
        if opts.use_cycle_consistency_loss:
            ...
            if opts.loss_fn == 'div':
                ...
                cycle_consistency_loss = nn.MSELoss(reconstructed_Y,images_Y) 
        ...
        if opts.loss_fn == 'div':
            ...
            g_loss = nn.MSELoss(D_Y(fake_Y),real_labels_X)
        # 3. Compute the cycle consistency loss (the reconstruction loss)
        # cycle_consistency_loss = ...
        if opts.use_cycle_consistency_loss:
            ...
            if opts.loss_fn == 'div':
                ...
                cycle_consistency_loss = nn.MSELoss(reconstructed_X,images_X)
